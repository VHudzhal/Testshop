	...
	class YITH_WCWL_Frontend_Premium extends YITH_WCWL_Frontend {
		...
		public function add_wishlist_links( $args = [] ) {
			$defaults = array(
				...
				'create_label' => __( 'Create a wishlist', 'yith-woocommerce-wishlist' ),
				...
				'search_label' => __( 'Search wishlist', 'yith-woocommerce-wishlist' ),
				...
				'manage_label' => __( 'Your wishlists', 'yith-woocommerce-wishlist' ),
