...
function EWD_URP_Display_Summary_Statistics($atts) {
	...
	if (isset($_GET['Product_Reviews'])) {return do_shortcode("[ultimate-reviews product_name='" . sanitize_text_field( $_GET['Product_Reviews'] ) . "']") ."<div class='ewd-urp-return'><a href='" . get_permalink() . "'>" . __("Back to Summary", 'ultimate-reviews') . "</a></div>";}
