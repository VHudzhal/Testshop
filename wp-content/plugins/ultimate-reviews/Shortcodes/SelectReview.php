...
function EWD_URP_Display_Review($Review, $Review_Params = array()) {
	...
	if($Verified_Buyer_Label == ''){$Verified_Buyer_Label = __("Verified Buyer", 'ultimate-reviews');}
	...
	$ReturnString .= "<div class='ewd-urp-hidden' itemprop='itemReviewed' itemscope itemtype='https://schema.org/" . $Items_Reviewed . "'>";
	$ReturnString .= "<meta itemprop='name' content='" . $Product_Name . "' />";
	$ReturnString .= "<div itemprop='aggregateRating' itemscope itemtype='https://schema.org/AggregateRating'>";
	$ReturnString .= "<meta itemprop='ratingValue' content='" . $Overall_Score . "' />";
	$ReturnString .= "<meta itemprop='ratingCount' content='1' />";
	...
	if($Verified_Buyer_Badge == 'Yes'){
		$ReturnString .= "<div class='ewd-urp-verified-buyer-badge-container'>";
			$ReturnString .= "<div class='ewd-urp-verified-buyer-badge-image'>&#10004</div>";
			$ReturnString .= "<div class='ewd-urp-verified-buyer-badge-text'>" . $Verified_Buyer_Label . "</div>";
		$ReturnString .= "</div>";
	}
