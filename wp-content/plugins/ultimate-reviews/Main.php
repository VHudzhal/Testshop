...
function EWD_URP_Enable_Sub_Menu() {
	...
	if ($Admin_Approval == "Yes") {
		$submenu['EWD-URP-Options'][6] = $submenu['EWD-URP-Options'][1];
		...
		$submenu['EWD-URP-Options'][5] = array( 'Export', 'edit_posts', "admin.php?page=EWD-URP-Options&DisplayPage=Export", "Export" );
	}
	else {
		...
		$submenu['EWD-URP-Options'][4] = array( 'Export', 'edit_posts', "admin.php?page=EWD-URP-Options&DisplayPage=Export", "Export" );
	}
