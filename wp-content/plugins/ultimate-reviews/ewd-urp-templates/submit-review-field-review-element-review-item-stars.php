...
<div class='ewd-urp-meta-field'>
	...
	<div class='ewd-urp-stars-input'>
		...
		<input type='text' id='ewd-urp-<?php echo esc_attr( $this->get_element_input_name() ); ?>' class='ewd-urp-hidden <?php echo $this->element_required(); ?>' name='<?php echo esc_attr( $this->get_element_input_name() ); ?>' value='<?php echo ( ! empty( $_POST[ esc_attr( $this->get_element_input_name() ) ] ) ? esc_attr( intval( $_POST[ esc_attr( $this->get_element_input_name() ) ] ) ) : '' ); ?>' <?php echo $this->element_required(); ?> />
