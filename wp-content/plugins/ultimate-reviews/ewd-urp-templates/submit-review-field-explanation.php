...
<div class='ewd-urp-meta-field'>
	...
	<textarea name='<?php echo esc_attr( $this->get_element_input_name() ); ?>_explanation' class='ewd-urp-review-textarea' <?php echo $this->element_required(); ?> >
		<?php echo ( isset( $_POST[ $this->get_element_input_name() . "_explanation"] ) ? esc_html( sanitize_textarea_field( $_POST[ $this->get_element_input_name() . "_explanation"] ) ) : '' ); ?>
	</textarea>
