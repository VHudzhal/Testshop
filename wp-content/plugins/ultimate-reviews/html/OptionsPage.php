...
$Items_Reviewed = get_option("EWD_URP_Items_Reviewed");
...
$Verified_Buyer_Badge = get_option("EWD_URP_Verified_Buyer_Badge");
...
$Verified_Buyer_Label = get_option("EWD_URP_Verified_Buyer_Label");
...
$urp_Rating_Stars_Color = get_option("EWD_urp_Rating_Stars_Color");
$urp_Verified_Checkmark_Color = get_option("EWD_urp_Verified_Checkmark_Color");
$urp_Verified_Checkmark_Background_Color = get_option("EWD_urp_Verified_Checkmark_Background_Color");
$urp_Verified_Checkmark_Text_Color = get_option("EWD_urp_Verified_Checkmark_Text_Color");
...
$Items_Reviewed = ($Items_Reviewed != '' ? $Items_Reviewed : 'Product');

$Display_Tab = (isset($_POST['Display_Tab']) ? sanitize_text_field( $_POST['Display_Tab'] ) : '');
?>
		...
		<form method="post" action="admin.php?page=EWD-URP-Options&DisplayPage=Options&Action=EWD_URP_UpdateOptions">
			...
			<div id='Premium' class='urp-option-set <?php echo ( ($Display_Tab == 'Premium') ? '' : 'urp-hidden' ); ?>'>
				...
				<table class="form-table ewd-urp-premium-options-table">
					...
					<tr>
						<th scope="row">Items Reviewed</th>
						<td>
							<fieldset><legend class="screen-reader-text"><span>Items Reviewed</span></legend>
								<select name='items_reviewed'>
									<?php foreach ($Reviewable_Items as $Schema_Type => $Reviewable_Item) { ?>
										<option value='<?php echo $Schema_Type; ?>' <?php echo $Schema_Type == $Items_Reviewed ? 'selected' : ''; ?>><?php echo $Reviewable_Item; ?></option>
									<?php } ?>
								</select>	
								<p>For microdata to work correctly, the type of items being reviewed needs to be specified.</p>
							</fieldset>
						</td>
					</tr>
					<tr>
			...
			<div id='WooCommerce' class='urp-option-set <?php echo ( ($Display_Tab == 'WooCommerce') ? '' : 'urp-hidden' ); ?>'>
				...
				<table class="form-table ewd-urp-premium-options-table <?php echo $URP_Full_Version; ?>">
					...
					<tr class="ewd-urp-admin-conditional-wc-options<?php echo ($Replace_WooCommerce_Reviews != 'Yes' ? ' urp-hidden' : ''); ?>">
						<th scope="row">Verified Buyer Badge</th>
						<td>
							<fieldset><legend class="screen-reader-text"><span>Verified Buyer Badge</span></legend>
								<div class="ewd-urp-admin-hide-radios">
									<label title='Yes'><input type='radio' name='verified_buyer_badge' value='Yes' <?php if($Verified_Buyer_Badge == "Yes") {echo "checked='checked'";} ?> <?php if ($URP_Full_Version != "Yes") {echo "disabled";} ?> /> <span>Yes</span></label><br />
									<label title='No'><input type='radio' name='verified_buyer_badge' value='No' <?php if($Verified_Buyer_Badge == "No") {echo "checked='checked'";} ?> <?php if ($URP_Full_Version != "Yes") {echo "disabled";} ?> /> <span>No</span></label><br />
								</div>
								<label class="ewd-urp-admin-switch">
									<input type="checkbox" class="ewd-urp-admin-option-toggle" data-inputname="verified_buyer_badge" <?php if($Verified_Buyer_Badge == "Yes") {echo "checked='checked'";} ?>>
									<span class="ewd-urp-admin-switch-slider round"></span>
								</label>		
								<p>Enable to display a "Verified Buyer" badge on reviews. (Requires that "Verified Buyers Only" be enabled.)</p>
							</fieldset>
						</td>
					</tr>
				...
				<div class="ewd-urp-admin-styling-section <?php echo $URP_Full_Version; ?>">
					<div class="ewd-urp-admin-styling-subsection">
						...
						<div class="ewd-admin-labelling-section">
							...
							<label>
								<p><?php _e("Verified Buyer", 'ultimate-reviews')?></p>
								<input type='text' name='verified_buyer_label' value='<?php echo $Verified_Buyer_Label; ?>' <?php if ($URP_Full_Version != "Yes") {echo "disabled";} ?>/>
							</label>
						</div>
					</div>
					<?php if ($URP_Full_Version != "Yes") { ?>
			...
			<div id='Styling' class='urp-option-set <?php echo ( ($Display_Tab == 'Styling') ? '' : 'urp-hidden' ); ?>'>
				...
				<div class="ewd-urp-admin-styling-section">
					...
					<div class="ewd-urp-admin-styling-subsection">
						<div class="ewd-urp-admin-styling-subsection-label"><?php _e('Rating Stars', 'ultimate-reviews'); ?></div>
						<div class="ewd-urp-admin-styling-subsection-content">
							<div class="ewd-urp-admin-styling-subsection-content-each">
								<div class="ewd-urp-admin-styling-subsection-content-label"><?php _e('Color', 'ultimate-reviews'); ?></div>
								<div class="ewd-urp-admin-styling-subsection-content-right">
									<div class="ewd-urp-admin-styling-subsection-content-color-picker">
										<div class="ewd-urp-admin-styling-subsection-content-color-picker-label"></div>
										<input type='text' class='urp-spectrum' name='urp_rating_stars_color' value='<?php echo $urp_Rating_Stars_Color; ?>' <?php if ($URP_Full_Version != "Yes") {echo "disabled";} ?> />
									</div>
								</div>
							</div>
						</div>
					...
					<div class="ewd-urp-admin-styling-subsection">
						<div class="ewd-urp-admin-styling-subsection-label"><?php _e('Verified Buyer Badge', 'ultimate-reviews'); ?></div>
						<div class="ewd-urp-admin-styling-subsection-content">
							<div class="ewd-urp-admin-styling-subsection-content-each">
								<div class="ewd-urp-admin-styling-subsection-content-label"><?php _e('Colors', 'ultimate-reviews'); ?></div>
								<div class="ewd-urp-admin-styling-subsection-content-right">
									<div class="ewd-urp-admin-styling-subsection-content-color-picker">
										<div class="ewd-urp-admin-styling-subsection-content-color-picker-label"><?php _e('Background', 'ultimate-reviews'); ?></div>
										<input type='text' class='urp-spectrum' name='urp_verified_checkmark_background_color' value='<?php echo $urp_Verified_Checkmark_Background_Color; ?>' <?php if ($URP_Full_Version != "Yes") {echo "disabled";} ?> />
									</div>
									<div class="ewd-urp-admin-styling-subsection-content-color-picker">
										<div class="ewd-urp-admin-styling-subsection-content-color-picker-label"><?php _e('Checkmark', 'ultimate-reviews'); ?></div>
										<input type='text' class='urp-spectrum' name='urp_verified_checkmark_color' value='<?php echo $urp_Verified_Checkmark_Color; ?>' <?php if ($URP_Full_Version != "Yes") {echo "disabled";} ?> />
									</div>
									<div class="ewd-urp-admin-styling-subsection-content-color-picker">
										<div class="ewd-urp-admin-styling-subsection-content-color-picker-label"><?php _e('Text', 'ultimate-reviews'); ?></div>
										<input type='text' class='urp-spectrum' name='urp_verified_checkmark_text_color' value='<?php echo $urp_Verified_Checkmark_Text_Color; ?>' <?php if ($URP_Full_Version != "Yes") {echo "disabled";} ?> />
									</div>
								</div>
							</div>
						</div>
