...
function EWD_URP_Add_Modified_Styles() {
	...
	$StylesString .="}\n";
	$StylesString .=".ewd-urp-review-score .dashicons-star-filled, .ewd-urp-review-score .dashicons-star-empty { ";
		if (get_option("EWD_urp_Rating_Stars_Color") != "") {$StylesString .= "color:" .  get_option("EWD_urp_Rating_Stars_Color") . ";";}
	$StylesString .="}\n";
	$StylesString .=".ewd-urp-verified-buyer-badge-image { ";
		if (get_option("EWD_urp_Verified_Checkmark_Color") != "") {$StylesString .= "color:" .  get_option("EWD_urp_Verified_Checkmark_Color") . ";";}
		if (get_option("EWD_urp_Verified_Checkmark_Background_Color") != "") {$StylesString .= "background:" .  get_option("EWD_urp_Verified_Checkmark_Background_Color") . ";";}
	$StylesString .="}\n";
	$StylesString .=".ewd-urp-verified-buyer-badge-text { ";
		if (get_option("EWD_urp_Verified_Checkmark_Text_Color") != "") {$StylesString .= "color:" .  get_option("EWD_urp_Verified_Checkmark_Text_Color") . ";";}
	$StylesString .="}\n";
	//read more button
