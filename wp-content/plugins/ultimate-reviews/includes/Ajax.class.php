...
if ( !class_exists( 'ewdurpAJAX' ) ) {
	...
	class ewdurpAJAX {
		...
		public function get_review_body() {
    		...
    		echo "<span class='ewd-urp-ajax-read-less' data-thumbnailchars='" . $ewd_urp_controller->settings->get_setting( 'thumbnail-characters' ) . "'>" . __( 'Read Less', 'ultimate-reviews' ) . "</span>";
    		echo "</span>";
