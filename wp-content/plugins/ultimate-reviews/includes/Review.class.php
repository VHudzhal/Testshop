...
class ewdurpReview {
	...
	public function load_wp_post( $post ) {
		...
		$this->review_image_id = get_post_thumbnail_id( $post );
	...
	public function validate_submission() {
		...
		$this->score = $this->score ? $this->score : ( count( $this->scores ) ? array_sum( $this->scores ) / count( $this->scores ) : 0 );
	...
	public function validate_review_image_field() {
		...
		$this->review_image_id = $attach_id;
	}
