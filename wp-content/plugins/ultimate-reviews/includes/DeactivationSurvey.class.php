					...
					<div class="ewd-urp-deactivate-survey-options">
						<?php foreach ( $options as $id => $option ) : ?>
							<div class="ewd-urp-deactivate-survey-option">
								<label for="ewd-urp-deactivate-survey-option-ultimate-reviews-<?php echo $id; ?>" class="ewd-urp-deactivate-survey-option-label">
									<input id="ewd-urp-deactivate-survey-option-ultimate-reviews-<?php echo $id; ?>" class="ewd-urp-deactivate-survey-option-input" type="radio" name="code" value="<?php echo $id; ?>" />
