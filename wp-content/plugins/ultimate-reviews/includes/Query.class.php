...
class ewdurpQuery {
	...
	public function prepare_args() {
		...
		if ( ! empty( $args['custom_filters'] ) ) { 
			...
			$custom_filters = json_decode( $args['custom_filters'] );
	...
	public function parse_request_args() {
		...
		if ( isset( $_REQUEST['review_author'] ) ) { 
			...
			$args['review_author'] = sanitize_text_field( stripslashes( $_REQUEST['review_author'] ) );
		}

		if ( isset( $_REQUEST['product_name'] ) ) { 

			$args['product_name'] = sanitize_text_field( stripslashes( $_REQUEST['product_name'] ) ); 
		}
